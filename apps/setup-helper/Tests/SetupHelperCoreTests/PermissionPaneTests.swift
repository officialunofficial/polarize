...
final class PermissionPaneTests: XCTestCase {
    ...
    func testAutomationMapsToNoPaneInThisSlice() {
        XCTAssertNil(SettingsPane.urlString(for: .automation(target: "Finder")))
    }
    ...
    func testAutomationOnlyLaunchCallsOpenZeroTimes() {
        var opened: [String] = []
