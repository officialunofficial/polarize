...
//! that reads it. `polarize`'s own `codesign`-only signing story has
//! no equivalent to the desktop host app's Xcode-managed signing
...
/// Group container, for `apps/polarize`'s startup log. It mirrors
